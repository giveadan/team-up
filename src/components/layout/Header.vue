<template>
  <header class="fixed w-full bg-white top-0 py-3">
    <div class="container mx-auto">
      <div class="flex">
        <div class="lg:w-1/2 lg:pr-4 py-3 text-center">
          <router-link to="/"><span class="py-2 mt-2 tracking-widest uppercase font-bold text-2xl">Team Up</span></router-link>
        </div>
        <div class="ml-auto">
          ...
          <button @click="isOpen = !isOpen" type="button" class="block text-gray-800 hover:text-gray-900 focus:text-gray-900 focus:outline-none md:hidden">
